...
Static archive of the website that ran at **best.hr/aibg** until 2026-09-10, when the WordPress server
behind it was retired. Every page here is plain HTML. There is no database, no PHP and nothing to
keep patched.

Intended home: **aibg.best.hr**

- 5 published pages, 531 files, 116.0 MB
- Verified: every page and asset requested over HTTP, 452 URLs, **0 failures**
...
address, **aibg@best.hr**. This archive is public and outlives the students named in it. People's names
...
Checked on 2026-09-11: captures run from 2015-10-23 to at least 2026-04-22, with 25 distinct HTML pages answering 200. A fresh capture of every published page was requested on 2026-09-11.
